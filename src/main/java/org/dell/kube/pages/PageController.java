...
public class PageController {
    ...
    public ResponseEntity<Page> create(@RequestBody Page page) {
        logger.info("CREATE-INFO:Trying to create page for = " + page.businessName);
        logger.debug("CREATE-DEBUG:Trying to create page for = " + page.businessName);
        Page newPage= pageRepository.create(page);

        logger.info("CREATE-INFO:Created  page for = " + page.businessName + "with id = " + newPage.id);
        logger.debug("CREATE-DEBUG:Created  page for = " + page.businessName + "with id = " + newPage.id);
    ...
    public ResponseEntity<List<Page>> list() {
        ...
        logger.debug("LIST-INFO:Fetching all pages");
